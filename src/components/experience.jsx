                ...
                <div className="timeline-centered">
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2><div style={{color:"#f33612", fontSize:"25px"}}>Full Stack Software/IoT Developer</div><div style={{fontSize:"19px"}}>IoTRight <span>April 2019-present</span></div><div style={{fontSize:"15px"}}>Syracuse, New York</div><a href="https://iotright.com/" target="_blank" style={{color:"#1889f1", fontSize:"15px"}}>www.iotright.com</a></h2>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                      <h2><div style={{color:"#f33612", fontSize:"25px"}}>Research and Development Intern</div><div style={{fontSize:"19px"}}>Crucible of Reasearch and Innovation Lab <span>April 2016 - August 2016</span></div><div style={{fontSize:"15px"}}>Bangalore, India</div><a href="https://cori.pes.edu/" target="_blank" style={{color:"#1889f1", fontSize:"15px"}}>cori.pes.edu</a></h2>
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                      <h2><div style={{color:"#f33612", fontSize:"25px"}}>Summer Intern</div><div style={{fontSize:"19px"}}>Microsoft Innovation Lab <span>April 2015 - August 2015</span></div><div style={{fontSize:"15px"}}>Bangalore, India</div><a href="https://mlabpesu.azurewebsites.net/" target="_blank" style={{color:"#1889f1", fontSize:"15px"}}>www.mlab.net</a></h2>
